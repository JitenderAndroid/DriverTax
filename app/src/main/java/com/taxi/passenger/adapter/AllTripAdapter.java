...
//        }
    ...
    public class AllTripViewHolder extends RecyclerView.ViewHolder{
        ...
        public AllTripViewHolder(View view) {
            ...
            txt_current_booking = view.findViewById(R.id.txt_current_booking);
            txt_trip_date = view.findViewById(R.id.txt_trip_date);
            txt_pickup_address = view.findViewById(R.id.txt_pickup_address);
            txt_drop_address = view.findViewById(R.id.txt_drop_address);
            txt_booking_id = view.findViewById(R.id.txt_booking_id);
            txt_booking_id_val = view.findViewById(R.id.txt_booking_id_val);
            txt_truct_type = view.findViewById(R.id.txt_truct_type);
            txt_truct_type_val = view.findViewById(R.id.txt_truct_type_val);
            layout_footer_detail = view.findViewById(R.id.layout_footer_detail);
            layout_all_trip = view.findViewById(R.id.layout_all_trip);
            layout_status_cancle = view.findViewById(R.id.layout_status_cancle);
            img_status = view.findViewById(R.id.img_status);
            img_driver_image = view.findViewById(R.id.img_driver_image);
            img_cancle_status = view.findViewById(R.id.img_cancle_status);
    ...
    public interface OnAllTripClickListener {
         void scrollToLoad(int position);
         void clickDetailTrip(int position);
         void tripCancel(int position);
    }
}

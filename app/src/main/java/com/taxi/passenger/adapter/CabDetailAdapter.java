...
public class CabDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    ArrayList<CabDetail> cabDetailsArrayList;
    Activity activity;
    ...
    public CabDetailAdapter(Activity act,ArrayList<CabDetail> cabArray){
        activity = act;
    ...
    private void bindCabDetailFeedItem(int position, CabDetailViewHolder holder) {
        ...
        CabDetail cabDetails = cabDetailsArrayList.get(position);
        ...
        Log.d("Car Icon", "Car Icon = " + Url.CAR_IMAGE_URL +cabDetails.getIcon());
        if(!cabDetails.getIcon().equals("")) {
            Uri iconUri = Uri.parse(Url.CAR_IMAGE_URL +cabDetails.getIcon());
    ...
    public class CabDetailViewHolder extends RecyclerView.ViewHolder {
        ...
        public CabDetailViewHolder(View view) {
            ...
            img_car_icon = view.findViewById(R.id.img_car_icon);
            img_fix_rate_icon = view.findViewById(R.id.img_fix_rate_icon);
    ...
    public interface OnCabDetailClickListener {
         void CarDetailTab(int position);
    }
}

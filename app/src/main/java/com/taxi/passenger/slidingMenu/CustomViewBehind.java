package com.taxi.passenger.slidingMenu;
...
public class CustomViewBehind extends ViewGroup {
	...
	public void setMode(int mode) {
		if (mode == SlidingMenu.START_OF|| mode == SlidingMenu.RIGHT) {
			if (mContent != null)
	...
	public int getMenuPage(int page) {
		...
		if (mMode == SlidingMenu.START_OF && page > 1) {
			return 0;

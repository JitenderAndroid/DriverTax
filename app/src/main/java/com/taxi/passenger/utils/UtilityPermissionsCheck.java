...
/**
 * Created by Abhilasha Yadav on 11/23/2017.
 */

public class UtilityPermissionsCheck {
    public static final int MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE = 123;
    public static final int MY_PERMISSIONS_REQUEST_CAMERA = 110;
    ...
    public static boolean checkcheckPermissionCamera(final Context context) {
    ...
    public static boolean checkPermissionWriteExternal(final Context context) {
        int currentAPIVersion = Build.VERSION.SDK_INT;
        if (currentAPIVersion >= android.os.Build.VERSION_CODES.M) {
